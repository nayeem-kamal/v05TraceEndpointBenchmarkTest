...
java -javaagent:$4 -Ddd.service=$service -Ddd.trace.agent.v0.5.enabled=$v05 -Ddd.trace.debug=true -Ddd.jmxfetch.statsd.host=unix:///home/ubuntu/mon/dsd.socket -jar /home/ubuntu/v05TraceEndpointBenchmarkTest/target/v05Test-0.0.1-SNAPSHOT.jar $2 $3 $5 &
JAVA_PID=$!
